  ...
  return (
    <>
      ...
      <div className={`p-4 h-screen  lg:block ${rightsideShow === true ? "block" : "hidden"
        ...
        <div
          className={`lg:flex flex-col h-full pb-14 pt-4 px-3 md:p-3 rounded-xl  bg-[#cec6c63a] md:col-span-6 sm:col-span-6 no-scrollbar  ${rightsideShow === true ? "flex" : "hidden"
            }`}
        >
