...
function ProfilePage({ profile, setProfile, profileuser }) {
            ...
            <div className="modal-container mx-auto">
              <div className="modal-content bg-white w-96 mx-auto mt-10 p-4 rounded-lg z-[100]">
                ...
                <div className="max-w-2xl mx-4 sm:max-w-sm md:max-w-sm lg:max-w-sm xl:max-w-sm sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto  bg-white shadow-xl rounded-lg text-gray-900">
                  <button
                    className="m-2 block mx-auto rounded-full hover:shadow-lg font-semibold text-black ml-72 px-6 py-1"
                    onClick={() => {
                      setProfile(false);
                    }}
                  >
                  ...
                  <div className="text-center mt-2">
                    <h2 className="font-semibold">
                      {profileuser && profileuser[0]?.name}
                    </h2>
                  ...
                  <div className="p-4 border-t mx-8 mt-2">
                    <button className="w-1/2 block mx-auto rounded-full bg-[#5a5269] hover:shadow-lg font-semibold text-white px-6 py-2">
                      Follow
                    </button>
                  </div>
                </div>
